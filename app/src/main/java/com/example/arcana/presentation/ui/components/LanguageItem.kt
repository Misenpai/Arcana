            ...
            val iconResId = when (item) {
                is LanguageDomainModel -> {
                    when (item.name.lowercase()) {
                        "python" -> com.example.arcana.R.drawable.python
                        "javascript" -> com.example.arcana.R.drawable.javascript
                        "swift" -> com.example.arcana.R.drawable.swift
                        "kotlin" -> com.example.arcana.R.drawable.kotlin
                        "c++" -> com.example.arcana.R.drawable.cpp
                        "java" -> com.example.arcana.R.drawable.java
                        "css" -> com.example.arcana.R.drawable.css
                        else -> null
                    }
                }
                else -> null
